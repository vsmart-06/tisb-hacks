...
class Login:
    def __init__(self):
        ...
        self.username_lbl = ttk.Label(self.username_frame, text = "Username: ")
        self.password_lbl = ttk.Label(self.password_frame, text = "Password: ")
        self.username_lbl.grid(row = 0, column = 0, padx = 10, pady = 10)
        self.password_lbl.grid(row = 0, column = 0, padx = 10)
        ...
        self.password_ent.grid(row = 0, column = 1)
    ...
    def signup(self):
        ...
        if self.username == "":
            ...
            self.error_lbl_usr.grid(row = 1, column = 1, pady = 10)
            return
